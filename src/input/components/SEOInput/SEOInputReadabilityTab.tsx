...
export const SEOInputReadabilityTab: React.FunctionComponent<Props> = ({ hidden, insights, value }) => {
    ...
    const transitionWordsSentencePercentage = React.useMemo(() => {
        if (insights?.transitionWords) return Math.round(insights.transitionWords.transitionWordSentences / insights.transitionWords.totalSentences * 100);
        return 0;
    }, [insights]);
